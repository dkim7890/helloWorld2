...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'dkim7890', 'email': 'dkim7890@terpmail.umd.edu', 'first_name':'David', 'last_name':'Kim',
            'password': generate_password_hash('dkim7890', method='pbkdf2:sha256'), 'role':'STUDENT'}
    ]
    ...
    students = [
        ...
        {'first_name': 'David', 'last_name': 'Kim', 'email':'dkim7890@terpmail.umd.edu',
            'major_id': 3, 'birth_date': dt.strptime('2003-04-15', '%Y-%m-%d'), 'is_honors': 0}
    ]
